        ...
        <div className='container p-3'>
            <div className='row'>
                <div className='col-lg-6 col-sm-12 col-md-6 p-5'>
                    ...
                    <p className='text-muted'>Not just an app, but a whole ecosystem.Our investmenets in 30+ fintech startups offer you tailored services specific to your needs.</p>
